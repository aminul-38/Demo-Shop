  ...
  return (
    <>
      <div className="container about mt-3 p-3 fw-medium fs-4">
        <h1>About Us</h1>
        <p clssName="">
          Welcome to Demo Shop! <br /> At Demo Shop, we're more than just an
          online store; we're your go-to destination for all gadgets. Our
          journey began with a simple idea: to provide our customers with the
          best quality products, outstanding service, and a shopping experience
          that's both convenient and enjoyable.
        </p>
        <h2>Our Mission</h2>
        <p clssName="fw-medium fs-1">
        ...
        <h2>Our Team</h2>
        <p clssName="fw-medium fs-3">
          Meet the passionate individuals behind Demo Shop. We're a diverse team
          of tech-savvy experts and dedicated customer service professionals who
          share a common goal: to exceed your expectations.
        </p>
        <h2>Contact Us</h2>
        <p clssName="fw-medium fs-3">
          Have a question, feedback, or just want to say hello? We'd love to
          hear from you! Feel free to{" "}
          <a
            href="mailto:aminulimam@gmail.com?Subject=Reservation"
            target="_blank"
          >
            Mail
          </a>
          .<br /> Thank you for choosing Demo Shop. We're honored to be a part
          of your shopping journey. <b>Happy Shopping!</b>
        </p>
      </div>
    </>
  );
